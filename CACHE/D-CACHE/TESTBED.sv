...
*
* Description:
*   D-Cache integration testbench with the project AXI4 bus, synchronous
*   behavioral BRAM, protocol assertions, and self-checking stimulus.
******************************************************************************/
...
module TESTBED;
    ...
    logic CPU_WR_EN;
    logic [DATA_W-1:0] CPU_WR_DATA;
    logic [DATA_W/8-1:0] CPU_WR_STRB;
    logic BUSY;
